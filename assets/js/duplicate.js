...
if (typeof janelaUnica === "undefined")
{
    var janelaUnica = false;
}

$(document).ready(function () {
    var href = document.location.href;
    if (href.indexOf("viewformalizacao") > -1 | href.indexOf("viewcase") > -1 | janelaUnica == true)
    {
        return;
    }
    if (window.IsDuplicate()) {
        if (typeof jsAcaoPaginaDuplicada !== "undefined")
        {
