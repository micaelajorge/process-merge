...
$TituloPagina = "Feriados Nacionais";
if (!empty($Id))
	{
	$SQL = "select * from FeriadosFederais where Id_Feriado = $Id";
...
<div id="Acoes"> <a href="TipoVolumeList.php" title="Voltar">Voltar</a> <a href="#" title="Salvar" onClick="Salvar()">Salvar</a> 
  <?php
if (!empty($Id))
	{
?>
...
<div id="DivEdit">
<form name="FrmEdit" action="FeriadosFederaisPost.php">
