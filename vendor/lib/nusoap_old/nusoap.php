...
/*
$Id: nusoap.php,v 1.2 2007/04/11 13:51:53 mmoscz Exp $
...
* @version  $Id: nusoap.php,v 1.2 2007/04/11 13:51:53 mmoscz Exp $
* @access   public
*/
class nusoap_base {
	/**
	...
	*/
	function service($data){
		...
		if (ereg('wsdl', $qs) ){
			...
			//error_log("In service, invoke the request " . $data, 0);
